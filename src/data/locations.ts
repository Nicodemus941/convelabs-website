...
export const locations: Record<string, LocationData> = {
  ...
  "winter-park": {
    slug: "winter-park",
    name: "Winter Park",
    tagline: "Serving Winter Park's Distinguished Community",
    heroTitle: "Winter Park Mobile Phlebotomy Services",
    heroDescription: "Premium mobile phlebotomy in Winter Park, FL. Professional at-home and office blood draws on Park Avenue, Hannibal Square, and surrounding areas.",
    badgeText: "Winter Park's Trusted Lab Service",
    badgeColor: "from-teal-100 to-teal-50 border-teal-200 text-teal-800",
    seo: {
      title: "Winter Park Mobile Phlebotomy Services | At-Home Blood Draws | ConveLabs",
      description: "Premium mobile phlebotomy services in Winter Park, FL. Professional at-home and office blood draws with same-day appointments.",
      keywords: "Winter Park phlebotomy, mobile blood draw Winter Park, at-home lab services Winter Park, Park Avenue blood draw",
      canonicalPath: "/winter-park",
    ...
    trustSignals: [
      { title: "Same-Day Available", description: "Appointments throughout Winter Park" },
      { title: "Certified & Insured", description: "Licensed professionals you can trust" },
      { title: "Premium Service", description: "Matching Winter Park's standards of excellence" },
    ],
    specialServices: [
      {
        title: "At-Home Blood Draws",
        description: "Professional phlebotomists come directly to your Winter Park home for complete comfort and privacy.",
        features: ["Park Avenue area coverage", "Fasting-friendly scheduling", "Family appointments"],
      },
      {
        title: "Office & Professional Services",
        description: "Efficient blood draws at your Winter Park business or professional office.",
        features: ["Downtown Winter Park offices", "Corporate programs", "Multi-employee visits"],
      },
    ],
    serviceAreas: [
      { name: "Park Avenue", description: "Shopping and dining district" },
      { name: "Hannibal Square", description: "Historic neighborhood" },
      { name: "Winter Park Village", description: "Mixed-use community" },
      { name: "Mead Botanical Garden Area", description: "Residential enclave" },
    ],
    whyChoose: [
      { title: "Local Expertise", description: "Deep knowledge of Winter Park neighborhoods." },
      { title: "Distinguished Service", description: "Matching the community's refined standards." },
      { title: "Convenient Scheduling", description: "Flexible times including early morning." },
      { title: "Membership Value", description: "Save significantly with our membership plans." },
    ],
    ctaTitle: "Experience Premium Service in Winter Park",
    ctaDescription: "Join Winter Park professionals who've elevated their healthcare with ConveLabs.",
  },
