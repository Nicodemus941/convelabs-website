...
const ReviewStep: React.FC<ReviewStepProps> = ({ form, onSubmit, onBack, services }) => {
          ...
          <div className="bg-gray-50 p-4 rounded-md">
            ...
            <div className="pl-6 space-y-1">
              <p>
                ...
                {services.find(s => s.id === form.getValues("serviceDetails.selectedService"))?.name || "Not selected"}
              </p>
              <p>
                <span className="text-gray-500">Fasting Required:</span>{" "}
                {form.getValues("serviceDetails.fasting") ? "Yes" : "No"}
              </p>
