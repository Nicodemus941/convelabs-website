  ...
  return (
    <DashboardWrapper>
      <Helmet>
        ...
        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Doctor Phillips Mobile Phlebotomy Services | ConveLabs" />
        <meta property="og:description" content="Premium mobile phlebotomy services in Doctor Phillips, FL. Professional at-home and office blood draws with same-day appointments." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://convelabs.com/doctor-phillips" />
        <meta property="og:image" content="https://convelabs.com/images/doctor-phillips-mobile-phlebotomy.jpg" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Doctor Phillips Mobile Phlebotomy Services | ConveLabs" />
        <meta name="twitter:description" content="Premium mobile phlebotomy services in Doctor Phillips, FL. Professional at-home and office blood draws." />
        <meta name="twitter:image" content="https://convelabs.com/images/doctor-phillips-mobile-phlebotomy.jpg" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "ConveLabs Doctor Phillips",
            "description": "Premium mobile phlebotomy services in Doctor Phillips, Florida",
            "url": "https://convelabs.com/doctor-phillips",
        ...
        <link rel="canonical" href="https://convelabs.com/doctor-phillips" />
      </Helmet>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Luxury Mobile Phlebotomy Services in <span className="text-conve-red">Doctor Phillips, Florida</span>
            </h1>
            <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
              Experience executive-level concierge blood draws at your Bay Hill estate or high-end office. 
              Our certified phlebotomists serve Dr Phillips' most affluent communities including Sand Lake, Phillips Landing, 
              and Restaurant Row with VIP appointments and ultimate discretion.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-6 bg-gray-50 rounded-xl">
              ...
              <p className="text-gray-600">Emergency and routine appointments available throughout Doctor Phillips</p>
            </div>
            <div className="text-center p-6 bg-gray-50 rounded-xl">
          ...
          {/* Our Doctor Phillips Services */}
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h2 className="text-3xl font-bold text-center mb-8">Our Doctor Phillips Services</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <Link 
                to="/services/doctor-phillips/home-blood-draws" 
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2 group-hover:text-conve-red transition-colors">
                      At-Home Blood Draws in Doctor Phillips
                    </h3>
                    <p className="text-gray-600 mb-4">
                      Professional phlebotomists come directly to your Doctor Phillips residence, providing 
                      the upscale service that Doctor Phillips residents deserve.
                    </p>
                    <ul className="text-sm text-gray-500 space-y-1">
                      <li>• Perfect for families with children</li>
                      <li>• Early morning fasting appointments</li>
                      <li>• Serving all Doctor Phillips neighborhoods</li>
                    </ul>
              ...
              <Link 
                to="/services/doctor-phillips/office-services" 
                className="group border border-gray-200 rounded-lg p-6 hover:border-conve-red hover:shadow-md transition-all"
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2 group-hover:text-conve-red transition-colors">
                      Office Services in Doctor Phillips
                    </h3>
                    <p className="text-gray-600 mb-4">
                      Keep your busy schedule on track with discreet and efficient blood draws 
                      at your Doctor Phillips workplace or business.
                    </p>
                    <ul className="text-sm text-gray-500 space-y-1">
          ...
          {/* Doctor Phillips Service Areas */}
          <div className="bg-gray-50 rounded-xl p-8 mb-12">
            <h2 className="text-3xl font-bold text-center mb-8">Doctor Phillips Service Areas We Cover</h2>
          ...
          {/* Why Choose ConveLabs in Doctor Phillips */}
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            <h2 className="text-3xl font-bold text-center mb-8">Why Doctor Phillips Residents Choose ConveLabs</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                "Local knowledge of Sand Lake Road traffic patterns",
          ...
          <div className="text-center bg-conve-red/5 p-8 rounded-xl border border-conve-red/10">
            <h2 className="text-3xl font-bold mb-4">Ready to Experience Premium Service in Doctor Phillips?</h2>
            <p className="text-lg mb-6 max-w-2xl mx-auto">
              Join hundreds of Doctor Phillips residents who have simplified their lab testing experience 
