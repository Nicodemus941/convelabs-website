...
const WinterParkServices: React.FC = () => {
  ...
  // If no service type is provided, redirect to Winter Park main page
  if (!serviceType || !winterParkServicesContent[serviceType]) {
    return <Navigate to="/services/winter-park" replace />;
  }
  ...
  return (
    <DashboardWrapper>
      <Helmet>
        ...
        <meta property="og:url" content={`https://convelabs.com/services/winter-park/${serviceType}`} />
        <link rel="canonical" href={`https://convelabs.com/services/winter-park/${serviceType}`} />
      </Helmet>

      <Container className="py-12">
        <div className="max-w-4xl mx-auto">
          {/* Back to Winter Park link */}
          <Link to="/services/winter-park" className="inline-flex items-center text-muted-foreground hover:text-primary mb-8">
