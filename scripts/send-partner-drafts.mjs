...
const emails = [
  ...
  // ── 8. KRISTEN BLAKE WELLNESS — Kristen (anytime Mon-Fri, patient-pay default) ──
  // NOTE: placeholder email kristen@kristenblakewellness.com — confirm real
  // inbox before firing the live send.
  {
    subjectPrefix: '[DRAFT → Kristen Blake Wellness]',
    actualRecipient: 'kristen@kristenblakewellness.com (Kristen Blake)',
