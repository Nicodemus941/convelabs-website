...
const STATIC_ROUTES = [
  ...
  { path: '/therapeutic-phlebotomy',
    title: 'Therapeutic Phlebotomy at Home — Orlando | ConveLabs',
    description: "Recurring therapeutic phlebotomy at home in Central Florida — for hemochromatosis & polycythemia. Licensed phlebotomists honor your physician's order. Book in 90 sec." },
  { path: '/specialty-kit-collection',
    title: 'Specialty Lab Kit Collection at Home — Orlando | ConveLabs',
    description: "Got a DUTCH, Genova, GI-MAP or Vibrant kit from your doctor? A licensed phlebotomist collects it at your home in Central Florida and ships it on time. Book in 90 sec." },
  { path: '/function-health-blood-draw',
    title: 'Function Health Blood Draw at Home — Orlando | ConveLabs',
    description: "Skip the Quest Patient Service Center. A licensed phlebotomist draws your Function Health panel at home in Orlando and delivers it to Quest. $150 flat. Book in 90 sec." },
  { path: '/guarantee',
